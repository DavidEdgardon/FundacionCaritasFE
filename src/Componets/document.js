...
export class Form3 extends Component {
    ...
    componentWillMount = () => {
        ...
        if (this.props.vals.Ninos === '') { ninos = 0; }
        else { ninos = parseInt(this.props.vals.Ninos); }
        if (this.props.vals.Ninas === '') { ninas = 0; }
        else { ninas = parseInt(this.props.vals.Ninas); }
        if (this.props.vals.Otros === '') { otros = 0; }
        else { otros = parseInt(this.props.vals.Otros); }
        ...
        if (this.props.vals.CUmep)
            umep = 'UMEP';
        if (this.props.vals.COmm)
            omm = 'OMM';
        if (this.props.vals.COng)
            ong = 'ONG';
        if (this.props.vals.CJuzgado)
            juzgado = 'Juzgado';
        if (this.props.vals.CFiscal)
            fiscal = 'Fiscal';    
                        ...
                        <tbody>
                            ...
                            <tr className="c9">
                                ...
                                <td className="c6" colSpan="2" rowSpan="1">
                                    ...
                                    <p className="c13"><span className="c7">{causaAlcohol} {causaEconomica} {causaInfiel} {causaOtros}</span></p>
                                </td>
                                <td className="c6" colSpan="2" rowSpan="1">
