                    ...
                    <Card style={{backgroundColor: card_background}}>
                        ...
                        <CardContent>
                            <Grid container  spacing={1} >
                                ...
                                <Grid item sm={3} >
                                    <Paper>
                                        <Input disableUnderline={true} id="num_identidad"  type="number" placeholder=" Numero de identidad" fullWidth defaultValue={vals.NumeroIdent} onChange={(e)=>handleChange(e,'NumeroIdent')}/>
                                    </Paper>
                                </Grid>
                            </Grid>
                        </CardContent>
                        ...
                        <CardContent>
                            <Grid container alignContent="space-between" spacing={1} >
                                ...
                                <Grid item sm={3} >
                                    <Paper>
                                        <Input disableUnderline={true} id="telefono" type="number" placeholder=" Telefono" fullWidth defaultValue={vals.Telefono} onChange={(e)=>handleChange(e,'Telefono')}/>
                                    </Paper>
                                </Grid>
                                <Grid item sm={3} >
                                    <Paper>
                        ...
                        <CardContent>
                            <Grid container alignContent="center" spacing={1} >
                                <Grid item sm={3}>
                                    <InputLabel htmlFor="tipo-condicion"> &nbsp; Beneficiados Indirectos</InputLabel>
                                </Grid>
                                <Grid item sm={3}>
                                    <Paper>
                                        <Input disableUnderline={true} id="CantNiños" type="number" placeholder=" Cant. niños" fullWidth defaultValue={vals.Ninos} onChange={(e)=>handleChange(e,'Ninos')}/>
                                    </Paper>
                                </Grid>
                                <Grid item sm={3}>
                                    <Paper>
                                        <Input disableUnderline={true} id="CantNiñas" type="number"  placeholder=" Cant. niñas" fullWidth defaultValue={vals.Ninas} onChange={(e)=>handleChange(e,'Ninas')}/>
                                    </Paper>
                                </Grid>
                                <Grid item sm={3}>
                                    <Paper>
                                        <Input disableUnderline={true} id="CantOtros" type="number" placeholder=" Cant. otros" fullWidth defaultValue={vals.Otros} onChange={(e)=>handleChange(e,'Otros')}/>
                                    </Paper>
                                </Grid>
                            </Grid>
                        </CardContent>
