...
class FormPatients extends Component {
    ...
    render() {
        ...
        return ( <
            ...
            style = {
                { width: "70%", alignSelf: "center", margin: "2%" } } >
            <
            Card style = {
            ...
            <
            h3 style = {
                { textAlign: "center" } } > & nbsp; Paciente < /h3> <
            /div> <
            CardContent >
            <
            ...
            id = "nom_paciente"
            placeholder = " Nombre"
            fullWidth defaultValue = { vals.Nombre }
            ...
            fullWidth defaultValue = { vals.PrimerA }
            ...
            fullWidth defaultValue = { vals.SegundoA }
            ...
            fullWidth defaultValue = { vals.NumeroIdent }
            ...
            fullWidth defaultValue = { vals.Direccion }
            ...
            Paper >
            <
            NativeSelect disableUnderline = { true }
            id = "beneficiario-parroquia"
            fullWidth onChange = { e => handleChange(e, "Parroquia") }
            value = { vals.Parroquia } >
            <
            option value = ""
            disabled >
            Beneficiario por parroquia <
            /option> { this.generateParroquiaType() } <
            /NativeSelect> <
            /Paper>
            ...
            NativeSelect disableUnderline = { true }
            id = "departamento"
            fullWidth onChange = { e => handleChange(e, "Departamento") }
            value = { vals.Departamento } >
            <
            option value = ""
            disabled >
            Departamento <
            /option> { this.generateDepartamentos() } <
            /NativeSelect> { /*<Input disableUnderline={true} placeholder=" Departamento" fullWidth  defaultValue={vals.Departamento} onChange={(e)=>handleChange(e,'Departamento')}/>*/ } <
            /Paper> <
            /Grid> <
            Grid item sm = { 3 } >
            <
            ...
            fullWidth defaultValue = { vals.Telefono }
            ...
            TextField type = "date"
            id = "fecha_nacimiento"
            fullWidth onChange = { e => handleChange(e, "Date") }
            value = { vals.Date }
            /> <
            /Paper> <
            /Grid> <
            ...
            NativeSelect disableUnderline = { true }
            id = "estado-civil"
            fullWidth onChange = { e => handleChange(e, "EstadoCivil") }
            value = { vals.EstadoCivil } >
            <
            option value = ""
            disabled >
            Estado civil <
            /option> { this.generateCivilState() } <
            /NativeSelect> <
            /Paper> <
            /Grid>
            ...
            NativeSelect disableUnderline = { true }
            id = "genero"
            fullWidth onChange = { e => handleChange(e, "Genero") }
            value = { vals.Genero } >
            <
            option value = ""
            disabled > { " " }
            ...
            id = "oficio"
            placeholder = " Oficio"
            fullWidth defaultValue = { vals.Oficio }
            ...
            NativeSelect disableUnderline = { true }
            id = "educacion"
            fullWidth onChange = { e => handleChange(e, "Educacion") }
            value = { vals.Educacion } >
            <
            option value = ""
            disabled >
            Nivel de educacion <
            /option> { this.generateEducationLevel() } <
            /NativeSelect> <
            /Paper> <
            /Grid> <
            Grid item sm = { 7 } >
            ...
            NativeSelect disableUnderline = { true }
            id = "ocupacion"
            fullWidth onChange = { e => handleChange(e, "EstadoOcupacion") }
            value = { vals.EstadoOcupacion } >
            <
            option value = ""
            disabled >
            Ocupacion <
            /option> { this.generateOcupationType() } <
            /NativeSelect> <
            /Paper> <
            /Grid> <
            /Grid> <
            ...
            Grid item sm = { 3 } >
            <
            InputLabel htmlFor = "tipo-condicion" > { " " } & nbsp; Beneficiados Indirectos < /InputLabel> <
            /Grid> <
            Grid item sm = { 3 } >
            <
            Paper >
            ...
            fullWidth defaultValue = { vals.Ninos }
            ...
            fullWidth defaultValue = { vals.Ninas }
            ...
            fullWidth defaultValue = { vals.Otros }
