...
class FormCases extends Component {
  ...
  onCasUbicacionChange = e => {
    if (e.target.value === "VRural") {
      this.props.handleUbicacion("VRural", true);
      this.props.handleUbicacion("VUrbana", false);
    } else {
      this.props.handleUbicacion("VRural", false);
      this.props.handleUbicacion("VUrbana", true);
    }
  };
                ...
                <Grid item sm={4}>
                  <Paper>
                    <NativeSelect
                      ...
                      fullWidth
                      value={
                        vals.VRural ? "VRural" : vals.VUrbana ? "VUrbana" : ""
                      }
                      onChange={e => this.onCasUbicacionChange(e)}
                    >
                      <option value="" disabled>
                        {" "}
                        Ubicación Caso{" "}
                      </option>
                      <option value={"VRural"}>Rural</option>
                      <option value={"VUrbana"}>Urbana</option>
                    </NativeSelect>
                  </Paper>
                </Grid>
                <Grid item sm={4}>
