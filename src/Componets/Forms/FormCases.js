                    ...
                    <Card style={{ backgroundColor: card_background }}>
                        ...
                        <CardContent>
                            <Grid container spacing={1}>
                                <Grid item sm={4}>
                                    <Paper>
                                        <NativeSelect disableUnderline={true} id="estado-atencion" disabled="disabled" fullWidth value={vals.EstadoAtencion} onChange={(e) => handleChange(e, 'EstadoAtencion')}>
                                            <option value="" disabled> Espera </option>
                        ...
                        <CardContent>
                            <Grid container alignContent="stretch" spacing={8}>
                                ...
                                <Grid item sm={4}>
                                    <InputLabel htmlFor="acceso-justicia"> &nbsp; Acceso a la justicia</InputLabel>
                                    <List id="acceso-justicia">
                                        <ListItem key="umep">
                                            <Checkbox id="Umep" onChange={(e) => handleCheckBox(e, 'CUmep')} checked={vals.CUmep} />
                                            <ListItemText primary="UMEP" />
                                        </ListItem>
                                        <ListItem key="omm">
                                            <Checkbox onChange={(e) => handleCheckBox(e, 'COmm')} checked={vals.COmm} />
                                            <ListItemText primary="OMM" />
                                        </ListItem>
                                        <ListItem key="ong">
                                            <Checkbox  onChange={(e) => handleCheckBox(e, 'COng')} checked={vals.COng} />
                                            <ListItemText primary="ONG" />
                                        </ListItem>
                                        <ListItem key="juzgado">
                                            <Checkbox onChange={(e) => handleCheckBox(e, 'CJuzgado')} checked={vals.CJuzgado} />
                                            <ListItemText primary="Juzgado" />
                                        </ListItem>
                                        <ListItem key="fiscal">
                                            <Checkbox onChange={(e) => handleCheckBox(e, 'CFiscal')} checked={vals.CFiscal} />
                                ...
                                <Grid item sm={4}>
                                    ...
                                    <List id="causa-violencia">
                                        ...
                                        <ListItem key="otros">
                                            <Checkbox onChange={(e) => handleCheckBox(e, 'COtros')} checked={vals.COtros} />
