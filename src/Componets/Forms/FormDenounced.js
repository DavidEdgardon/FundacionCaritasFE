                    ...
                    <Card style={{backgroundColor: card_background}}>
                        ...
                        <CardContent>
                            <Grid container  spacing={1} >
                                ...
                                <Grid item sm={3} >
                                    <Paper>
                                        <Input disableUnderline={true} id="num_identidad_d" type="number" placeholder=" Numero de identidad" fullWidth defaultValue={vals.NumeroIdentD} onChange={(e)=>handleChange(e,'NumeroIdentD')}/>
                                    </Paper>
                                </Grid>
                            </Grid>
                        </CardContent>
                        ...
                        <CardContent>
                            <Grid container spacing={1} >
                                ...
                                <Grid item sm={3} >
                                    <Paper>
                                        <Input disableUnderline={true} id="telefono_d"  type="number" placeholder=" Telefono" fullWidth defaultValue={vals.TelefonoD} onChange={(e)=>handleChange(e,'TelefonoD')}/>
                                    </Paper>
                                </Grid>
                                <Grid item sm={3} >
                                    <Paper>
