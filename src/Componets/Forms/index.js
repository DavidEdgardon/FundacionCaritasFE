...
class Index extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            CUmep: false, COmm: false, COng: false, CJuzgado: false, CFiscal: false,
            Ninos: '', Ninas: '', Otros: '', CEconomica: false, CInfidelidad: false, CAlcoholismo: false,COtros: false,
    ...
    render() {
        const { NombreD, PrimerAD, SegundoAD, NumeroIdentD, DireccionD, LocalidadD, DepartamentoD, EstadoCivilD, OficioD, EducacionD, TelefonoD, DateD,
            ...
            EstadoAtencion, Terapeuta, VPsicologica, VFisica, VEconomica, VSexual, Victima, Agresor,CUmep,COmm,COng,CJuzgado,CFiscal,CInfidelidad, CEconomica, CAlcoholismo,COtros,
