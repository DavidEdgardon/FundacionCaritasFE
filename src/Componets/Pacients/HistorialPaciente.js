...
<Dialog maxWidth="100px" open={vals.open2} onClose={this.CloseDialog} TransitionComponent={Transition}>
          ...
          <Card style={{ backgroundColor: card_background }}>
            <Card style={{ backgroundColor: card_background }}>
              <div style={{ textAlign: "center" }}>
                <h3 style={{ textAlign: "center" }}> &nbsp;Auditoria Paciente </h3>
              </div>
              <CardContent>
              ...
              <Grid item  xs={7} sm={3}>
                  ...
                  <Grid item  xs={7} sm={3}>
                    ...
                    <TextField id="outlined-basic" label="Fecha Creacion" variant="outlined" />
                   
                  </Grid>
                  <Grid item  xs={7} sm={3}>
                   
                    <TextField id="outlined-basic" label="Usuario Modifico" variant="outlined" />
                   
                  </Grid>
                  <Grid item xs={7} sm={3}>
                   
                    <TextField id="outlined-basic" label="Fecha Ultima Actualizacion" variant="outlined" />
